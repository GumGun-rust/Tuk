...
pub(in crate::buffers::text_buffer) struct Cursor {
    ...
    //location of the upper left corner of the buffer
    pub offset: TPos<u16>,
...
impl Cursor {
    ...
    pub(super) fn move_down_visual(&mut self, line_len:usize) {
        self.move_down();
    }
    ...
    pub(super) fn move_up_visual(&mut self, lines:usize, line_len:usize) {
        
        self.move_up(lines, line_len);
    }
    
    
    #[inline(always)]
    pub(super) fn move_up(&mut self, lines:usize, line_len:usize) {
        self.doc_cursor_visual.rows -= 1;
        self.doc_position.rows -= 1;
    }
...
mod down {
    ...
    pub(in crate::buffers::text_buffer) 
    fn can_move_visual(buffer:&mut Cursor, line_count:usize, amount:usize) -> MoveType {
